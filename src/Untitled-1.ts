...
import LeadsForm from "./leadsfrom";
...
const TABLE_BANNER_COLUMNS: BannerColumn[] = [
  {
    key: "actions",
    label: "Full View",
    groupLabel: "ACTION",
...
const LEAD_STATUS_OPTIONS: LeadRecord["status"][] = [
  "New",
  "Kyc",
  "RFQ",
  "Hot",
  ...
  return (
    <div className="w-full overflow-auto">
          ...
          <div className="flex flex-wrap items-center gap-1">
            <div className="flex flex-wrap items-center gap-2 ml-10">
              ...
              <div className="flex items-center justify-between bg-green-800 px-4 py-1 shadow-md border rounded-md border-green-800 min-w-[140px] h-10">
                <span className="font-extrabold text-md text-white">BOOK</span>
                <span className="font-extrabold text-md text-white">
                  {bookLeads}
                </span>
                <span className="text-md font-bold text-white">
      ...
      <div className="mt-2 bg-white border shadow-sm rounded-3xl border-white w-full">
        <div className="relative border border-white rounded-2xl overflow-hidden h-[62vh]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              onClick={() => handlePageChange(currentPage + 1)}
              className="px-2 text-sm border rounded disabled:opacity-40 hover:bg-gray-100"
            >
              Next
            </button>
          </div>
